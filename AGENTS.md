...
When adding, renaming, removing, or changing the purpose of a skill, update its linked description in [README.md](README.md) in the same change. Keep the skill catalog complete and alphabetical. Update the installation instructions when the repository URL or installation method changes.
